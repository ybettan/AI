...
to continue ? [y/n] ") != 'y':
    ...
    player0_wins = int(res[players[0]]/(res[players[0]]+res[players[1]])*100)
    player1_wins = int(res[players[1]]/(res[players[0]]+res[players[1]])*100)
